# Brain.fm Clone Project

- [x] Research Brain.fm <!-- id: 0 -->
    - [x] Analyze Brain.fm features (UI/UX, modes, sessions) <!-- id: 1 -->
    - [x] Investigate Brain.fm's sound generation technology (patents, whitepapers, articles) <!-- id: 2 -->
    - [x] Research alternative algorithmic music generation libraries/APIs <!-- id: 3 -->
